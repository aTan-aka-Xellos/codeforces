...
public class Solution1066C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String testFile = "Codeforces Round #515 (Div. 3)/test/%s";
        String testAns  = "Codeforces Round #515 (Div. 3)/test/%sa";
...
//        }
    ...
    static void solve() {
        ...
        for (int i = 0; i < q; i++) {
            ...
            if (cmd.equals("L")) a[id] = left--;
            if (cmd.equals("R")) a[id] = right++;
            if (cmd.equals("?")) out.println(min(abs(a[id] - left), abs(a[id] - right)) - 1);
        }
    }
